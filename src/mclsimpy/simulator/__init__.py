"""
Vessel Simulation Models (:mod:`mclsimpy.simulator`)
=======================================================

The mclsimpy simulator package contains a set of
different simulation models.

Contents
---------
The following modules are found in the `mclsimpy.simulator`.
